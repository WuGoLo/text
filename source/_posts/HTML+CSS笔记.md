...
![](HTML+CSS笔记/弹性布局709.png)
{% asset_img 弹性布局709.png "" %}
#### ◆  Flex容器分析
...
![](HTML+CSS笔记/1542805342930.png)
{% asset_img 1542805342930.png "" %}
##### ☞ justify-content
...
![](HTML+CSS笔记/1542847221906.png)
{% asset_img 1542847221906.png "" %}
![](HTML+CSS笔记/1542848447293.png)
{% asset_img 1542848447293.png "" %}
![](HTML+CSS笔记/1542848983066.png)
{% asset_img 1542848983066.png "" %}
![](HTML+CSS笔记/1542848754765.png)
{% asset_img 1542848754765.png "" %}
![](HTML+CSS笔记/1542849348203.png)
{% asset_img 1542849348203.png "" %}
##### ☞ align-items
...
![](HTML+CSS笔记/align-items.jpg)
{% asset_img align-items.jpg "" %}
##### ☞ flex-wrap

默认情况下，项目都排在一条线（又称”轴线”）上。flex-wrap属性定义，如果一条轴线排不下，如何换行。

![](HTML+CSS笔记/弹性布局2004.png)
{% asset_img 弹性布局2004.png "" %}
~~~css
.box {
...
![](HTML+CSS笔记/弹性布局2085.png)
{% asset_img 弹性布局2085.png "" %}
![](HTML+CSS笔记/弹性布局2106.png)
{% asset_img 弹性布局2106.png "" %}
![](HTML+CSS笔记/弹性布局2135.png)
{% asset_img 弹性布局2135.png "" %}
##### flex-flow
...
![](HTML+CSS笔记/弹性布局3029.png)
{% asset_img 弹性布局3029.png "" %}
#### ◆  Flex子元素的属性
...
![](HTML+CSS笔记/1542856894145.png)
{% asset_img 1542856894145.png "" %}
##### ☞ flex-grow
...
![](HTML+CSS笔记/1542857301282.png)
{% asset_img 1542857301282.png "" %}
