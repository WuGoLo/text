...
> 注意: 在使用`v-for`时,要把一个唯一值赋值给`:key`属性(通常是数组的index或者数据的id)
...
![](./Vue基础/1534228452013.png)
{% asset_img 1534228452013.png "" %}
### ☛ 删除功能
...
![](./Vue基础/1534229426837.png)
{% asset_img 1534229426837.png "" %}
`add.vue`
