...
![1497317567484](assets/1497317567484.png)

![1496916239525](assets/1496916239525.png)
...
![1496981558575](assets/1496981558575.png)
...
- 转义符
  ...
  ![1498289626813](assets/1498289626813.png)
...
- +，-0等运算
  ...
  ```javascript
  var str = '500';
  console.log(+str);		// 取正 结果：字符串
  console.log(-str);		// 取负 结果：数字
  console.log(str - 0);
  ```
...
![1497497605587](assets/1497497605587-8288640195.png)

#### 复杂类型作为函数的参数

![1497497865969](assets/1497497865969.png)
